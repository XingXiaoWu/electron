...
import { app, protocol, BrowserWindow, Menu, globalShortcut, Tray, nativeImage } from 'electron'
...
async function createWindow() {
    ...
    if (process.env.WEBPACK_DEV_SERVER_URL) {
        ...
        // 远程地址写在这
        mainWindow.loadURL(process.env.VUE_APP_SITE ? process.env.VUE_APP_SITE : 'https://www.baidu.com')
    }
}
...
function createTray() {
    ...
    tray.setToolTip(process.env.VUE_APP_ProjectName)
